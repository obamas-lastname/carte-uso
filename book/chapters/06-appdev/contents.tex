...
% Reviewers: Răzvan Nițu, Vali Goșu, Lucian Cojocar, Mihai Maruseac, Vlad Dogaru, Dan Sîrbu, Lorena Balea, Liza Babu
...
Diferența dintre o aplicație compilată și una interpretată este că, spre deosebire de compilator, care generează un întreg fișier executabil care poate fi apoi rulat, interpretorul ia fiecare linie, generează codul mașină aferent ei, codul este rulat pe procesor, după care operația este reluată.
...
Pentru a-l instala urmăm pașii descriși la \url{https://code.visualstudio.com/Download/}.
...
De aceea a apărut Node.js, care e o platformă ce permite executarea codului JavaScript în afara browserului.
...
E recomandat să scriem în incremente mici și să ne asigurăm că fiecare bloc funcționează.
